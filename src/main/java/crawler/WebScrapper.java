...
public class WebScrapper {
    public static void main(String[] args) {
        try {
            ...
            FileWriter csvWriter = new FileWriter("articles.csv");
            ...
            // Không dùng được cho nhiều trang web khác nhau do cấu trúc html, cách đặt tên khác nhau
                ...
                article.setTags(articleElement.select("div.stream-item__tag a").text());
                ...
                csvWriter.append("\"").append(article.getContent()).append("\","); // Không lấy nội dung ở đây
